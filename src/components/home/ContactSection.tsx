...
export function ContactSection() {
  ...
  const validateForm = () => {
    ...
    if (
      ...
      !/^\d{6,15}$/.test(formData.whatsapp.replace(/\s/g, ""))
    ) {
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    if (Object.keys(errors).length === 0) {
      ...
      if (!apiKey) {
        setFormErrors({
          submit:
            "The contact form is missing its configuration API key. Please set VITE_WEB3FORMS_KEY in your Vercel Environment Variables.",
        });
  ...
  return (
    <>
          ...
          <div className="relative mx-4 max-w-md rounded-3xl bg-white p-8 shadow-2xl">
            ...
            <div className="mt-6 text-center">
              ...
              <p className="mt-3 text-slate-600 leading-relaxed">
                Thank you for your inquiry. We've received your request and will
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="mt-1 text-slate-500">
                    Our team will review your travel preferences and send you a
                    personalized itinerary via email or WhatsApp.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section
        id="contact"
        className="border-t border-slate-200 bg-linear-to-b from-white via-slate-50 to-white py-20 sm:py-32"
      >
            ...
            <div className="mb-16">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="mx-auto mt-4 max-w-xl text-lg text-slate-600 leading-relaxed">
                  Connect directly with Najith on WhatsApp, send an email, or
                  fill out the booking form below. We'll reply within 24 hours.
                </p>
                ...
                <div className="mt-10 flex flex-wrap justify-center gap-6">
                  ...
                  <a
                    href="https://www.facebook.com/share/1D2nqmnMu5/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex flex-col items-center gap-3 transition-all duration-300"
                    title="Facebook"
                  >
                    <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-white text-blue-600 shadow-md border border-slate-100 transition-all duration-300 group-hover:-translate-y-1 group-hover:bg-blue-600 group-hover:text-white group-hover:shadow-lg group-hover:shadow-blue-600/25">
                      <svg
                        className="h-8 w-8"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                  ...
                  <a
                    href="https://www.instagram.com/travelmelanka?igsh=azd3Zmk0and4aWE3"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="group flex flex-col items-center gap-3 transition-all duration-300"
                    title="Instagram"
                  >
                    <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-white text-pink-500 shadow-md border border-slate-100 transition-all duration-300 group-hover:-translate-y-1 group-hover:bg-linear-to-br group-hover:from-pink-500 group-hover:via-red-500 group-hover:to-orange-400 group-hover:text-white group-hover:shadow-lg group-hover:shadow-pink-500/25">
                      <svg
                        className="h-8 w-8"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                  ...
                  <a
                    ...
                    title="Tripadvisor"
                  >
                    <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-white text-[#00AF87] shadow-md border border-slate-100 transition-all duration-300 group-hover:-translate-y-1 group-hover:bg-[#00AF87] group-hover:text-white group-hover:shadow-lg group-hover:shadow-[#00AF87]/25">
                      <svg
                        className="h-8 w-8"
                        fill="currentColor"
                        viewBox="0 0 24 24"
          ...
          <div className="grid gap-6 sm:gap-8 md:grid-cols-2">
            <ScrollReveal>
              <div className="flex h-full w-full min-h-[300px] md:min-h-[350px] overflow-hidden rounded-3xl border border-slate-200 shadow-sm">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.7588888140735!2d79.92579661057509!3d6.919402193051371!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae25725fa7f8333%3A0x64331e0d977ddd4!2sTravel%20Me%20Lanka!5e0!3m2!1sen!2slk!4v1784083906463!5m2!1sen!2slk"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
              ...
              <div className="flex flex-col gap-6">
                <div>
                  ...
                  <p className="mt-2 text-sm text-slate-600">
                    Send your destination and dates we'll reply with options.
                  </p>
                </div>

                <form
                  onSubmit={handleFormSubmit}
                  className="rounded-3xl border border-slate-200 p-4 shadow-sm sm:p-6"
                >
