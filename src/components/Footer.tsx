          ...
          <div className="lg:col-span-5">
            ...
            <div className="mt-8 flex gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex h-12 w-12 items-center justify-center rounded-xl bg-white/10 text-white backdrop-blur-sm border border-white/10 transition-all duration-300 hover:bg-[#00AF87] hover:border-[#00AF87] hover:scale-110 hover:shadow-lg hover:shadow-[#00AF87]/25"
              >
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
